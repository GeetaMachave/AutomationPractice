package constructor;
 ...
 class Cons0 {
	...
	Cons0(double num2){
		System.out.println("I am double and int parameter constructor");
	}

	
	public static void main(String[] args) {
		
		Cons0 c1=new Cons0(36.21);//calling default constructor of the current class written by java compiler
		Cons0 c2=new Cons0(25);
		Cons0 c3=new Cons0();
